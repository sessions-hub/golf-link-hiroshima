...
export default function TokushoPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--off)', display: 'flex', flexDirection: 'column' }}>
      <div style={{ background: 'var(--g1)', padding: '52px 20px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ fontSize: 16, fontWeight: 700, color: 'white' }}>特定商取引法に基づく表記</div>
      </div>
