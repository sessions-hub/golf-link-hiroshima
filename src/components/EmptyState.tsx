  ...
  return (
    <div className="empty">
      ...
      <style jsx>{`
        ...
        .halo{position:absolute;inset:0;border-radius:50%;background:radial-gradient(circle,rgba(201,162,39,.16),transparent 68%)}
        .bw img{height:120px;position:relative;z-index:1;filter:drop-shadow(0 10px 18px rgba(0,0,0,.4))}
        .msg{font-size:15px;font-weight:500;color:#f3f1e9;margin-top:4px}
        .sub{font-size:12px;color:#7d9285;line-height:1.7;margin-top:6px}
