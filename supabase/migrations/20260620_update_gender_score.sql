-- 性別スコアを 異性+6 / 同性・other・null は +2 に統一
-- 変更前: 異性+10 / 同性+5 / null+5
...
BEGIN
  ...
  IF p1.gender IS NOT NULL AND p2.gender IS NOT NULL
     AND p1.gender != 'other' AND p2.gender != 'other'
     AND p1.gender != p2.gender THEN
    score := score + 6;
  ELSE
    score := score + 2;
  END IF;
